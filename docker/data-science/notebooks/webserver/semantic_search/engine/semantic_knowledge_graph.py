# %load -s generate_request_root,generate_facets,validate_skg_request_input,generate_skg_request,transform_node,transform_response_facet,traverse webserver/semantic_search/engine/semantic_knowledge_graph
...
def generate_skg_request(*multi_nodes):
    """Generates a faceted SKG request from a set of multi-nodes. 
       ...
       :param int min_occurance: Maps to mincount on the facet.
       :param int limit: Maps to limit on the facet.
       Each subsequent node is applied as a facet. 
       """
